    ...
    <div className="min-h-screen flex justify-center items-center  px-4 bg-gradient-to-br from-gray-100 to-gray-200">
      <main className="w-full max-w-xl bg-white shadow-md p-8 rounded-xl">
        <div className="flex justify-between">
                    ...
                    {/* Titre */}
                    <div className="mb-4">
                        <h1 className="text-3xl font-bold text-gray-800 uppercase font-serif text-center ">Ajouter une Tâche</h1>
                    </div>
                    {/* Retour */}
                    <button className="mb-6 border md:p-1 rounded sm:font-normal bg-gray-300/60">
                        <Link href="/tasks" className="flex gap-2 items-center text-blue-600 hover:text-blue-800 font-semibold">
